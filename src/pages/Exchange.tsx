            ...
            <div className="flex items-center justify-center gap-2 mb-8">
              {["simulate", "confirm", "transfer", "complete"].map((s, i) => (
                <div key={s} className="flex items-center">
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${step === s || ["simulate", "confirm", "transfer", "complete"].indexOf(step) > i
                  ...
                  {i < 3 && (
                    <div
                      className={`w-12 h-1 mx-2 ${["simulate", "confirm", "transfer", "complete"].indexOf(step) > i
                        ? "bg-emerald"
                        : "bg-muted"
                        }`}
                    />
